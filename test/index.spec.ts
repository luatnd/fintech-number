...
describe('index', () => {
  ...
  it('test_dynamicNumberFormat', () => {
    ...
    testCases = [
      ...
      { n: -0.000123456789, expected: '-0.000123457', desc: "small number should work for negative" },
      { n: -0.0000000123456789, expected: '-0.0000000123457', desc: "super small number should work for negative" },
      { n: 0.000000000123123456789, expected: '0.000000000123123', opt: undefined, desc: "auto should work in range 0-1" },
      { n: 0.000000000123456789, expected: '0.000000000123457', opt: undefined, desc: "auto should work in range 0 -> -1" },
      { n: -0.000000000123123456789, expected: '-0.000000000123123', opt: undefined, desc: "auto should work in range 0-1" },
      { n: -0.000000000123456789, expected: '-0.000000000123457', opt: undefined, desc: "auto should work in range 0 -> -1" },
      ...
      { n: -123449.789, expected: '-123,400', opt: { decimal: -2 }, desc: 'decimal negative with negative num auto up' },
      { n: 123456.789, expected: '123,500', opt: { decimal: -2 }, desc: 'decimal negative auto up' },
      { n: -123456.789, expected: '-123,500', opt: { decimal: -2 }, desc: 'decimal negative with negative num auto up' },

      // round direction
      { n: 1234.51000, expected: '1,234.51', opt: { round: 'up' }, desc: 'can round up' },
      ...
      { n: -1234.50023, expected: '-1,234.50', opt: { round: 'down', meaningful: false }, desc: 'meaningful, negative' },
      ...
      { n: -0.0000000123, expected: '-0', opt: { decimal: 2, tinySupport: 6, showPlus: 1 }, desc: 'show plus, negative' },
      { n: 0.000123456789, expected: '+0.0001', opt: { decimal: 2, tinySupport: 6, showPlus: 1 }, desc: 'show plus' },
      { n: -0.000123456789, expected: '-0.0001', opt: { decimal: 2, tinySupport: 6, showPlus: 1 }, desc: 'show plus, negative' },

      // maxDecimal
      { n: 0.000123456, expected: '+0.000123', opt: { decimal: undefined, tinySupport: 5, maxDecimal: 6, showPlus: 1 }, desc: 'maxDecimal' },

      // minMeaningLength
      { n: 0.000123456, expected: '+0.0001', opt: { minMeaningLength: 1, showPlus: 1 }, desc: 'minMeaningLength' },
      { n: 0.0000000000123456, expected: '+0.00000000001', opt: { minMeaningLength: 1, showPlus: 1 }, desc: 'minMeaningLength' },

      // minMeaningLength + maxDecimal
      { n: 0.000123456, expected: '0.000123', opt: { minMeaningLength: 3 }, desc: 'maxDecimal has higher priority than minMeaningLength' },
      { n: 0.000123456, expected: '0.00012', opt: { minMeaningLength: 3, maxDecimal: 5, }, desc: 'maxDecimal has higher priority than minMeaningLength' },
    ];

    // testCases = [
    //   { n: -0.000123456, expected: '-0.000123', desc: "small number should work for negative" },
    // ]
